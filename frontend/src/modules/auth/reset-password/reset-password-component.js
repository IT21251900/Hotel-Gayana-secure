          ...
          <Form form={form} layout="vertical" className="mt-6 mx-6 md:mx-0" onSubmitCapture={onFinish}>
            ...
            >
              <Input.Password
                ...
                iconRender={(visible) => visible ? <EyeInvisibleOutlined onClick={togglePasswordVisibility} /> : <EyeOutlined onClick={togglePasswordVisibility} />}
              />
            </Form.Item>
            ...
            >
              <Input.Password
                ...
                iconRender={(visible) => visible ? <EyeInvisibleOutlined onClick={toggleNewPasswordVisibility} /> : <EyeOutlined onClick={toggleNewPasswordVisibility} />}
              />
            </Form.Item>
